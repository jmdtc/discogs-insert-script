...
export default class Genre extends Model<GenreAttributes, GenreCreationAttributes> {
    public id!: number;
    public name!: string;
...
export const initGenreModel = async function (sequelize: Sequelize): Promise<void> {
    try {
        Genre.init({
            id: {
